 ...
 * Unlike regular interface methods, they are declared with the default keyword 
 * at the beginning of the method signature, and they provide an implementation.
 * 
 * Interface's default method allow us to add new methods to an interface 
 * that are automatically available in the implementations. 
 * Thus, there's no need to modify the implementing classes.
 * In this way, backward compatibility is neatly preserved 
...
public interface MyList<E> extends Collection<E> {
  ...
  public default <E> E[] toArray(E[] array) {
    // Left as an exercise
    E[] anArr = (E[]) new Object[array.length] ;
